...
ON CONFLICT (icao) DO UPDATE SET
    ...
    state_id = COALESCE(EXCLUDED.state_id, airports.state_id),
    ...
    state_name = COALESCE(EXCLUDED.state_name, airports.state_name),
    country_name = COALESCE(EXCLUDED.country_name, airports.country_name),
