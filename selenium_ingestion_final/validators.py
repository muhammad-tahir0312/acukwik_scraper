...
VALIDATION_SCHEMAS = {
    "airport": {
        ...
        "properties": {
            ...
            "city": {"type": "string"},
            "country": {"type": "string"},
            "airport_type": {"type": ["string", "null"]},
            "coordinates_raw": {"type": ["string", "null"]},
            "elevation_raw": {"type": ["string", "null"]},
            "fuel_available": {"type": ["string", "null"]},
            "utc_offset": {"type": ["string", "null"]},
            "approaches": {"type": ["string", "null"]},
            "longest_runway_raw": {"type": ["string", "null"]},
            "runway_surface": {"type": ["string", "null"]},
            "pcn": {"type": ["string", "null"]},
            "airport_light_intensity": {"type": ["string", "null"]},
            "airport_of_entry": {"type": ["boolean", "null"]},
            "airport_of_entry_remarks": {"type": ["string", "null"]},
            "fire_category": {"type": ["string", "null"]},
            "fire_category_remarks": {"type": ["string", "null"]},
            "customs": {"type": ["boolean", "null"]},
            "us_customs_pre_clearance": {"type": ["boolean", "null"]},
            "slots_required": {"type": ["boolean", "null"]},
            "handling_mandatory": {"type": ["boolean", "null"]},
            "airport_email": {"type": ["string", "null"]},
            "airport_website": {"type": ["string", "null"]},
            "airport_manager_phone": {"type": ["string", "null"]},
            "airport_ownership": {"type": ["string", "null"]},
            "facility_use": {"type": ["string", "null"]},
            "dst": {"type": ["string", "null"]},
            "sunrise": {"type": ["string", "null"]},
            "sunset": {"type": ["string", "null"]},
            "open_24h": {"type": ["boolean", "null"]},
            "airport_hours": {"type": ["string", "null"]},
            "control_tower_hours": {"type": ["string", "null"]},
            "variation": {"type": ["string", "null"]},
            "distance_from_city": {"type": ["string", "null"]},
            "afs_aftn": {"type": ["string", "null"]},
            "local_standard_time": {"type": ["string", "null"]},
            "tower_frequency": {"type": ["string", "null"]},
            "atis_frequency": {"type": ["string", "null"]},
            "ctaf_frequency": {"type": ["string", "null"]},
            "airport_general_remarks": {"type": ["string", "null"]},
            "airport_contacts_raw": {"type": ["array", "null"]}
        },
        "required": ["name"]
    },
    "organization": {
    ...
    "clearance": {
        ...
        "properties": {
            ...
            "country_phone_code": {"type": ["string", "null"]},
            "currency": {"type": ["string", "null"]},
            "exchange_guide": {"type": ["string", "null"]},
            "time_zone": {"type": ["string", "null"]},
            "general_information": {"type": ["string", "null"]},
            "wgs84": {"type": ["string", "null"]},
            "visa": {"type": ["string", "null"]},
            "documentation": {"type": ["string", "null"]},
            "application_format": {"type": ["string", "null"]},
            "comments": {"type": ["string", "null"]},
            "clearance_contacts": {"type": "array", "items": {"type": "object"}},
            "associated_airports": {"type": "array", "items": {"type": "string"}}
        },
        "required": ["country"]
    },
    "nearby_airports": {
        ...
        "properties": {
            "associated_airports": {"type": "array", "items": {"type": "string"}},
            "nearby_airports": {"type": "array", "items": {"type": "object"}}
        },
        "required": ["associated_airports", "nearby_airports"]
    }
}
...
def validate_record(record: Dict[str, Any]) -> List[str]:
    ...
    try:
        # Only 'entity_type' and 'data' are required
        required_fields = ["entity_type", "data"]
